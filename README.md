...
- `pageSize`: Dataverse page size used while loading records; defaults to `5000`.
- `maxRecords`: optional hard cap. Leave as `null` to page through and display all matching tasks.
...
- Displays all loaded rows in a Gantt chart with Day, Week, and Month views, expanding the chart height to fit the task list.
